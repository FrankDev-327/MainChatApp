...
export class CarsEntity {
  ...
  @Column({ name: 'CarVoicePhone', type: 'varchar', length: 25, nullable: true })
  ...
  @Column({ name: 'IsMobilePhone', type: 'enum', enum: CarsYesNoEnum, default: CarsYesNoEnum.N })
  isMobilePhone: CarsYesNoEnum;

  @Column({ name: 'IsTrailer', type: 'enum', enum: CarsYesNoEnum, default: CarsYesNoEnum.N })
  ...
  @Column({ name: 'DefaultCarDivisionID', type: 'int', unsigned: true, default: 0 })
